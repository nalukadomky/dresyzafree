  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-medium text-white px-12",
        nav: "flex items-center gap-1",
        button_previous: "absolute left-[3.5rem] top-0 inline-flex items-center justify-center rounded-lg h-10 w-10 bg-transparent text-white/60 hover:text-white hover:bg-white/10 transition-colors",
        button_next: "absolute right-[3.5rem] top-0 inline-flex items-center justify-center rounded-lg h-10 w-10 bg-transparent text-white/60 hover:text-white hover:bg-white/10 transition-colors",
